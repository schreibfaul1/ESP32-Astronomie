...
String Astronomy::setInput(as_date d, as_time t){
    ...
    sprintf(buf,"%02d.%02d.%d",d.day, d.month, d.year); m_Date=String(buf);
    m_os = "\n";
    m_os+= "Oestl. geografische Laenge: ........... " + String(m_Lon) + " Grad\n" ;
    m_os+= "Geografische Breite: .................. " + String(m_Lat) + " Grad\n";
    m_os+= "Datum/Zeit: ........................... " + m_Date + " " + m_Time + "\n";
    m_os+= "Zeitdifferenz zu Weltzeit: ............ " + String(m_Zone) + " h\n";
    m_os+= "deltaT: ............................... " + String(m_DeltaT) +  " sek\n";
    m_os+= "Julianisches Datum: ................... " + String(m_JD) + " Tage\n";
    m_os+= "Greenwich Sternzeit  GMST: ............ " + m_GMST.HHMMSS + " = " + String(m_GMST.TotalHour, 4) + " h\n";
    m_os+= "Lokale Sternzeit LMST: ................ " + m_LMST.HHMMSS + " = " +String(m_LMST.TotalHour, 4) + " h\n";
    m_os+= "Entfernung der Sonne (Erdmittelpunkt):  " + String(m_SunDistance) + " km\n";
    m_os+= "Entfernung der Sonne (vom Beobachter):  " + String(m_SunDistanceObserver) + " km\n";
	m_os+= "Eklipt. Laenge der Sonne: ............. " + String(m_SunLon) + " Grad\n";
	m_os+= "Rektaszension der Sonne: .............. " + m_SunRA.HHMMSS + " = " + String(m_SunRA.TotalHour, 4) + " h\n";
	m_os+= "Deklination der Sonne: ................ " + String(m_SunDec) + " Grad\n";
	m_os+= "Azimut der Sonne: ..................... " + String(m_SunAz) + " Grad\n";
	m_os+= "Hoehe der Sonne ueber Horizont: ....... " + String(m_SunAlt) + " Grad\n";
	m_os+= "Durchmesser der Sonne: ................ " + String(m_SunDiameter) + " '\n";
	m_os+= "Astronomische Morgendaemmerung: ....... " + m_SunAstronomicalTwilightMorning.HHMMSS + " = " + String(m_SunAstronomicalTwilightMorning.TotalHour) + " h\n";
	m_os+= "Nautische Morgendaemmerung: ........... " + m_SunNauticalTwilightMorning.HHMMSS + " = " + String(m_SunNauticalTwilightMorning.TotalHour) + " h\n";
	m_os+= "Buergerliche Morgendaemmerung: ........ " + m_SunCivilTwilightMorning.HHMMSS + " = " + String(m_SunCivilTwilightMorning.TotalHour) + " h\n";
	m_os+= "Sonnenaufgang: ........................ " + m_SunRise.HHMMSS + " = " + String(m_SunRise.TotalHour) + " h\n";
	m_os+= "Sonnenkulmination: .................... " + m_SunTransit.HHMMSS + " = " + String(m_SunTransit.TotalHour) + " h\n";
	m_os+= "Sonnenuntergang: ...................... " + m_SunSet.HHMMSS + " = " + String(m_SunSet.TotalHour) + " h\n";
	m_os+= "Buergerliche Abenddaemmerung: ......... " + m_SunCivilTwilightEvening.HHMMSS + " = " + String(m_SunCivilTwilightEvening.TotalHour) + " h\n";
	m_os+= "Nautische Abenddaemmerung: ............ " + m_SunNauticalTwilightEvening.HHMMSS + " = " + String(m_SunNauticalTwilightEvening.TotalHour) + " h\n";
	m_os+= "Astronomische Abenddaemmerung: ........ " + m_SunAstronomicalTwilightEvening.HHMMSS + " = " + String(m_SunAstronomicalTwilightEvening.TotalHour) + " h\n";
	m_os+= "Tierkreiszeichen: ..................... " + TKZ[(int)m_SunSign] + "\n";
	m_os+= "Entfernung des Mondes (Erdmittelpunkt): " + String(m_MoonDistance) + " km\n";
	m_os+= "Entfernung des Mondes (vom Beobachter): " + String(m_MoonDistanceObserver) + " km\n";
	m_os+= "Eklipt. Laenge des Mondes: ............ " + String(m_MoonLon) + " Grad\n";
	m_os+= "Eklipt. Breite des Mondes: ............ " + String(m_MoonLat) + " Grad\n";
	m_os+= "Rektaszension des Mondes: ............. " + m_MoonRA.HHMMSS + " = " + String(m_MoonRA.TotalHour) + " h\n";
	m_os+= "Deklination des Mondes: ............... " + String(m_MoonDec) + " Grad\n";
	m_os+= "Azimut des Mondes: .................... " + String(m_MoonAz) + " Grad\n";
	m_os+= "Hoehe des Mondes ueber Horizont: ...... " + String(m_MoonAlt) + " Grad\n";
	m_os+= "Durchmesser des Mondes: ............... " + String(m_MoonDiameter) + " '\n";
	m_os+= "Mondaufgang: .......................... " + m_MoonRise.HHMMSS + " = " + String(m_MoonRise.TotalHour) + " h\n";
	m_os+= "Mondkulmination: ...................... " + m_MoonTransit.HHMMSS + " = " + String(m_MoonTransit.TotalHour) + " h\n";
	m_os+= "Monduntergang: ........................ " + m_MoonSet.HHMMSS + " = " + String(m_MoonSet.TotalHour) + " h\n";
	m_os+= "Mondphase: ............................ " + String(m_MoonPhaseNumber)+ "\n";
	m_os+= "Mondalter: ............................ " + String(m_MoonAge) + " Grad\n";
	m_os+= "Mondphase: ............................ " + phases[(int)m_MoonPhase] + "\n";
	m_os+= "Mondzeichen: .......................... " + TKZ[(int)m_MoonSign] + "\n";
    return res;
}
